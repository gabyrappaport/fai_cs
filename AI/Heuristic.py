...
class Heuristic:
	...
	def __init__(self, board, player_type=VAMPIRES, distance_lambda=linear, enemy_lambda=linear, distance_threshold=None):
		self.board = board
